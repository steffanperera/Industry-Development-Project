      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center h-16">
          <div className="flex items-center">
            <h1 className="text-2xl text-green-600">CareAble - Admin Panel</h1>
          </div>
          ...
          <nav className="hidden md:flex items-center space-x-8">
            ...
            <Link
          to="/admin" className="flex px-6 py-2 bg-green-600 text-white rounded-lg hover:bg-green-700 transition-colors">
            <span>Log Out </span>
