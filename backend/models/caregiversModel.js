...
FROM
    caregivers 
LEFT JOIN 
    assessments ON caregivers.id = assessments.caregiverId
GROUP BY
    caregivers.id;`;
        ...
        (err, result) => {
          ...
          db.query(
            ...
            (err, totalResult) => {
              ...
              const totalForAttempt =
                totalResult[0].total;

              /* =========================================
                 IF 60 QUESTIONS COMPLETED
                 CREATE ASSESSMENT
              ========================================= */
